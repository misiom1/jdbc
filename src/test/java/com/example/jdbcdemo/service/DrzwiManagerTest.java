...
public class DrzwiManagerTest {
	...
	Drzwi drzwi3 = new Drzwi(PRODUCENT_1, MODEL_3, KOLOR_2);
	...
	public void checkAdding(){
		...
		assertEquals(PRODUCENT_1, drzwiRetrieved2.getProducent());
	...
	public void CheckDeleting ()
	{
		...
		assertEquals(MODEL_1, drzwiRetrieved.getModel());
		assertEquals(KOLOR_1, drzwiRetrieved.getKolor());
		assertEquals(PRODUCENT_1, drzwiRetrieved1.getProducent());
